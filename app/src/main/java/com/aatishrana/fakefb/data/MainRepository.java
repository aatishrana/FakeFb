...
public class MainRepository
{
     ...
     */
    public Observable<Boolean> createNewFb(String url, final int state)
    {
        return Observable.create(new ObservableOnSubscribe<Boolean>()
        {
            ...
            {
                FbData fbdata = processData(getSampleJson(state));
                if (fbdata != null)
                {
                    dataState = state;
                    e.onNext(true);
    ...
    public Observable<FbData> getData()
    {
        return Observable.create(new ObservableOnSubscribe<FbData>()
        {
            ...
            {
                e.onNext(processData(getSampleJson(dataState)));
                e.onComplete();
            }
